import type { ResourceDescriptor, SortDir, SortExpr } from "./descriptor.js";
 ...
 */
export function sortableIds(d: AnyDescriptor): string[] {
...
export function resolveSort(
  ...
  return terms.map((expr) => ({ expr, ascending }));
}
 ...
 */
export function isSortable(d: AnyDescriptor, columnId: string): boolean {
